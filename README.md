...
| one command that proves it works | `cd ip-lab && python3 tools/selftest.py` (159 checks; `--offline` skips the 2 that need outbound TLS) |
...
Executed in this sandbox: `tools/selftest.py` → **159 checks passed** (parsers, the
